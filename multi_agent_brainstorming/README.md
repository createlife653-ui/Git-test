...
トピックを入力するプロンプトが表示されるので、入力してEnterを押してください。
...
### Claude CodeのSkillとして使用

Claude Codeの対話で以下のように言うだけで実行できます：

```
ブレインストーミング：新しい朝食メニューのアイデア
マルチエージェントで環境問題を議論して
```

システムが自動的にトピックを認識して実行します。
